...
class Mlp(nn.Module):
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, act_on_last=False, drop=0.):
        super().__init__()
        out_features = out_features or in_features
        hidden_features = hidden_features or in_features
        self.act_on_last = act_on_last
...
class Block(nn.Module):
    ...
    def forward(self, x, attention_mask=None, return_attention=False, rel_pos_bias=None):
        ...
        if self.gamma_1 is None:
            ...
            x = x + self.drop_path(self.gamma_1 * self.attn(self.norm1(x), attention_mask=attention_mask, rel_pos_bias=rel_pos_bias))
