...
def main(args, ds_init):
    ...
    dataset_train, args.nb_classes = dataset_train = build_instaformer_dataset(args=args, finetune=False)
    if args.disable_eval_during_finetuning:
        dataset_val = None
    else:
        dataset_val, _ = build_instaformer_dataset(args=args, finetune=False)
